...
function ProductCount({onDecrease, onIncrease, item}) {
  if(!item) return null;
    return (
    <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#F1F1F1", height: "100%", justifyContent: "center", width: "120px" }}>
